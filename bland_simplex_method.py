...
class Arguments:
    def __init__(self):
        ...
        self.obj_atrributes =  [50, 100]      #[5, 2] #an array of objective function coefficients----------5x_1 + 2x_2
        self.decision_variable_rhs=[28, 24]   #[6, 0] # right-hand side entries
        self.decision_variable_lhs =  [[7, 2], [2, 12]]  #[[1, 1],[1, -1 ]] #coefficients for the left-hand-sides of the constraints
